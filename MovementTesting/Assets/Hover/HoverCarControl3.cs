...
public class HoverCarControl3 : MonoBehaviour
{
  Rigidbody m_body;
  ...
  void Update()
  {
    ...
    // Main Thrust
    m_currThrust = 0.0f;
    float aclAxis = Input.GetAxis("P3_Vertical");
    ...
    float aclSideAxis = Input.GetAxis("P3_Horizontal");
    ...
    // Turning
    m_currTurn = 0.0f;
    float turnAxis = Input.GetAxis("P3_HorizontalTurn");
