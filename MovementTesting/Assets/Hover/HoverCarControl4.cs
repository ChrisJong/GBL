...
public class HoverCarControl4 : MonoBehaviour
{
  Rigidbody m_body;
  ...
  void Update()
  {
    ...
    // Main Thrust
    m_currThrust = 0.0f;
    float aclAxis = Input.GetAxis("P4_Vertical");
    ...
    float aclSideAxis = Input.GetAxis("P4_Horizontal");
    ...
    // Turning
    m_currTurn = 0.0f;
    float turnAxis = Input.GetAxis("P4_HorizontalTurn");
